...
module.exports = async function (context, req) {
    context.log('JavaScript HTTP trigger function processed a request for programs-delete.');
    ...
    try {
        ...
        // Assuming 'id' is the partition key for programs.
        await container.item(itemId, itemId).delete();

        context.res = { status: 204, body: "Item deleted successfully." };

    } catch (error) {
        context.log.error("Error in programs-delete: ", error);
        if (error.code === 404) {
